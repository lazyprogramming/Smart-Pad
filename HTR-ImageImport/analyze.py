...
class Constants:
    ...
    fnAnalyze = '../Images/analyze.png'
    fnPixelRelevance = '../Images/pixelRelevance.npy'
    fnTranslationInvariance = '../Images/translationInvariance.npy'
    fnTranslationInvarianceTexts = '../Images/translationInvarianceTexts.pickle'
    gtText = 'are'
