...
file_menu.add_command(label="Encrypt", command=encrypt, accelerator='Ctrl+Shift+E+C', underline=0)
file_menu.add_command(label="Decrypt", command=decrypt, accelerator='Ctrl+Shift+C+E', underline=0)
file_menu.add_command(label="Sentiment Analysis", command=sent_analysis, accelerator='Ctrl+Shift+S+A', underline=0)
file_menu.add_command(label="TEXT2SPEECH", command=text2speech, accelerator='Ctrl+Shift+T+A', underline=0)
file_menu.add_separator()
