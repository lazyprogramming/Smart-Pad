...
def run_this():
    ...
    """label2 = tk.Label(main_canvas, text='Enter Your Text:')
    label2.config(font=('helvetica', 10))
    label2.pack()
    main_canvas.create_window(200, 50, window=label2)

    entry1 = tk.Entry(sentimentWND)
    entry1.pack()
    main_canvas.create_window(200, 120, window=entry1)

    txt2analyze = entry1.get()
    print(txt2analyze)"""
